...
\textbf{Content support}&Data&RCS1&y/n&A system is assessed as possessing the feature (y) if it allows users to access the content in a structured and machine-readable manner.\\ \hline
\end{tabular}
...
\textbf{Creating new social connections}&Like button&SCN1&y/n&A system is assessed as possessing the feature (y) if it gives the ability to users to provide simple positive feedback (likes) on research artefacts. \\ \hline
